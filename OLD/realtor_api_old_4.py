...
with open (r"data.csv", 'w') as f:
    ...
    writer_obj.writerow(["id", "bathrooms_total", "bedrooms", "stories_total","size_interior", "building_type",
                        "agency_name", "agency_type", "property_type", "lng", "lat", "ownership_type", "land_size",
                        "parkings", "page_url", "timestamp", "province", "price"])
    ...
    for longitude in range(lng_min, lng_max):
        ...
        for page_num in range(1,51):
            ...
            try:
                ...
                safety_count += 1
                payload = f"LatitudeMax={latitude+1}&LongitudeMax={longitude+1}&LatitudeMin={latitude}&LongitudeMin={longitude}&CurrentPage={page_num}&Sort=6-D&PropertyTypeGroupID=1&TransactionTypeId=2&PropertySearchTypeId=0&Currency=CAD&RecordsPerPage=200&ApplicationId=1&CultureId=1&Version=7.0"
                ...
                if req_total != 0:
                    ...
                    for result in results:
                        ...
                        size_interior = result["Building"]["SizeInterior"]if "SizeInterior" in result["Building"] else "NaN"
                        ...
                        land_size = result["Land"]["SizeTotal"] if "SizeTotal" in result["Land"] else "NaN"
