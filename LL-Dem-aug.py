...
df_dem = pd.read_csv("data/LocalLogic/Demographics/demographics-2024-06-10.csv")
...
def write_to_csv(id, data):
    ...
    with open (r"data/LocalLogic/Demographics/demographics-2024-06-10.csv", 'a') as f:
