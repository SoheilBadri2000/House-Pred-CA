...
df_house = pd.read_csv("data/lof/data-lof-2024-06-03.csv")
df_dem = pd.read_csv("data/LocalLogic/Demographics/demographics-2024-06-03.csv")
...
def write_to_csv(id, data):
    ...
    with open (r"data/LocalLogic/Demographics/demographics-2024-06-03.csv", 'a') as f:
