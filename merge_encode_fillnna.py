...
df = pd.read_csv("data/lof/data-lof-2024-04-29.csv")
df_dem = pd.read_csv("data/LocalLogic/Demographics/demographics-2024-04-29.csv")
df_loc = pd.read_csv("data/LocalLogic/Locations/locations-2024-04-29.csv")
...
if __name__ == "__main__":
    ...
    df_enc.to_csv("data/enc/data-enc-2024-04-29.csv", index=False)