    ...
    for longitude in range(lng_min, lng_max):
        ...
        for page_num in range(1,51):
            ...
            try:
                ...
                safety_count += 1
                payload = f"LatitudeMax={latitude+1}&LongitudeMax={longitude+1}&LatitudeMin={latitude}&LongitudeMin={longitude}&CurrentPage={page_num}&Sort=6-D&PropertyTypeGroupID=1&TransactionTypeId=2&PropertySearchTypeId=0&Currency=CAD&RecordsPerPage=120&ApplicationId=1&CultureId=1&Version=7.0"
