...
df = pd.read_csv("data/aug/data-aug-2024-06-17.csv")
...
while len(urls) != 0:
        ...
        for url in urls_150:
            try:
                ...
                if not page.query_selector("span[class*='ControlBaseWrapper'] > h1"):
                  page.wait_for_selector("div[id='listingDetailsDataProvidedBy']") # *= means "contains"
    ...
    df.to_csv("data/aug/data-aug-2024-06-17.csv", index=False)
    urls = urls[150:]
